...
CREATE USER 'balaji@email.com'@'localhost' IDENTIFIED BY '12345678';
CREATE USER 'navin@org.com'@'localhost' IDENTIFIED BY '32165498';
CREATE USER 'patil@gmail.com'@'localhost' IDENTIFIED BY '45612378';
CREATE USER 'roshni@gmail.com'@'localhost' IDENTIFIED BY '78945612';
CREATE USER 'singh@org.com'@'localhost' IDENTIFIED BY '12345678';
CREATE USER 'geetika@org.com'@'localhost' IDENTIFIED BY '45678912';
CREATE USER 'desai@gmail.com'@'localhost' IDENTIFIED BY '78945612';
CREATE USER 'tambe@email.com'@'localhost' IDENTIFIED BY '12457836';

-- Grant roles to users
GRANT Admin TO 'balaji@email.com'@'localhost';
GRANT Receptionist TO 'navin@org.com'@'localhost';
GRANT Doctor TO 'patil@gmail.com'@'localhost';
GRANT Doctor TO 'roshni@gmail.com'@'localhost';
GRANT Nurse TO 'singh@org.com'@'localhost';
GRANT Nurse TO 'geetika@org.com'@'localhost';
GRANT Patient TO 'desai@gmail.com'@'localhost';
GRANT Patient TO 'tambe@email.com'@'localhost';


GRANT ALL privileges on Hospital_Final_Changes.* TO Admin with grant option;
